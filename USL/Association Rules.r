...
chi2tab<-crossTable(trans1, measure="support", sort=TRUE)
round(chi2tab,2)
...
#Significance of rules is tested with Fisherâs exact test and is corrected due to multi-comparisons
#About Fisher test: https://en.wikipedia.org/wiki/Fisher%27s_exact_test 
#About correction adjust=âbonferroniâ https://en.wikipedia.org/wiki/Bonferroni_correction 
#About correction adjust=âholmâ https://en.wikipedia.org/wiki/Holm%E2%80%93Bonferroni_method 
#About correction adjust=âfdrâ https://en.wikipedia.org/wiki/False_discovery_rate 
...
#The formal Jaccard index notation J (X, Y) = | Xâ©Y | / | XUY | -> similarity
...
#interpretation: orange & ham J=0.71 â are very different (in 71% they do not overlap)
...
#interpretation: transactions 6 & 1 J=0.25 â> they are very similar (in 25% they do not overlap). 
